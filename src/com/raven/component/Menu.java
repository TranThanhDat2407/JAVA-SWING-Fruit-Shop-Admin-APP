...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("3", "Category", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "Products", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Orders", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("6", "Statistics", Model_Menu.MenuType.MENU));
